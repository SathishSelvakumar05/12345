...
// import 'package:new_try/egypt_filePicker/screen/try_dio.dart';
...
//               labelName: 'Upload Inspection Image',
//               onImageSelected: (File selectedImage) async {
//                 // Call the assInspection function and pass the selected image file and token
//                 await assInspection(selectedImage, token);
//
//
//
//
...
//                       "inspectionDate": dateTimeToEpochString(formData['dateOfInspection']),
...
//                         "vehicleInspectionSticker": formData['Vehicle Inspection Sticker'],
//                         "complianceWithLocalRegulation": formData['Compliance with Local Regulations'],
...
//                             "Emission Control Systemimg": ["Emission Control System Image"],
//                           if(formData['Vehicle Inspection Stickerimg'] is String)
//                             "Vehicle Inspection Stickerimg": ["Vehicle Inspection Sticker Image"],
//                           if(formData['Compliance with Local Regulationsimg'] is String)
//                             "Compliance with Local Regulationsimg": ["Compliance with Local Regulations Image"],
//                         }
//                       },
//                     };
