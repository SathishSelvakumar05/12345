...
class RoundTourScreen extends StatefulWidget {
  bool? isUpdate = false;
  ...
  @override
  State<RoundTourScreen> createState() => _RoundTourScreenState();
}

class _RoundTourScreenState extends State<RoundTourScreen> {
          ...
          child: FormBuilder(
            ...
            child: Column(
              ...
              children: [
                ...
                AutoCustomTextField(
                  read: true,
                  labelName: 'Buffer Time',
                  name: 'bufferTime',
                  placeHolder: '00:30',
                  textEditingController: _bufferTimeController,
                  suffixIcon: Icon(Icons.access_time),
                  suffixClick: () {
                    print('buffer time');
                  },
                  validators: [
                    FormBuilderValidators.required(
                        errorText: 'Buffer Time is required'),
                  ],
                ),
